    ...
    <div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
      <div className="lg:mr-[2rem]">
        ...
        <p className="py-4">
          ...
          dignissimos similique optio, in sit laudantium assumenda eius
          molestiae ea accusamus eum.
        </p>
      ...
      <div className="lg:col-span-2 flex justify-between mt-6 lg:ml-[4rem]">
        <div>
